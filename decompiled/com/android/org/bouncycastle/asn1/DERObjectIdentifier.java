...
public class DERObjectIdentifier extends ASN1Primitive {
    ...
    public static ASN1ObjectIdentifier getInstance(Object obj) {
        ...
        if (obj instanceof byte[]) {
            ...
            try {
                return (ASN1ObjectIdentifier) ASN1Primitive.fromByteArray(enc);
            } catch (IOException e) {
    ...
    static {
        cache = new ASN1ObjectIdentifier[256][];
    }
    ...
    static ASN1ObjectIdentifier fromOctetString(byte[] enc) {
        ...
        synchronized (cache) {
            ...
            if (first == null) {
                first = new ASN1ObjectIdentifier[ReasonFlags.unused];
                cache[idx1] = first;
            }
            ASN1ObjectIdentifier possibleMatch = first[idx2];
            if (possibleMatch == null) {
                possibleMatch = new ASN1ObjectIdentifier(enc);
                first[idx2] = possibleMatch;
                ...
                if (possibleMatch == null) {
                    ...
                    return !Arrays.areEqual(enc, possibleMatch.getBody()) ? new ASN1ObjectIdentifier(enc) : possibleMatch;
                }
            }
        }
    }
