...
public class X509Name extends ASN1Object {
        ...
        try {
            ...
            for (int i = start; i != end; i += delta) {
                ...
                for (int j = 0; j < orderingSize; j++) {
                    if (!indexes[j]) {
                        if (oid.equals((ASN1ObjectIdentifier) other.ordering.elementAt(j))) {
    ...
    private void appendValue(java.lang.StringBuffer r8, java.util.Hashtable r9, com.android.org.bouncycastle.asn1.ASN1ObjectIdentifier r10, java.lang.String r11) {
        /*
        r7 = this;
        r6 = 92;
        r5 = 32;
    ...
    L_0x0075:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.org.bouncycastle.asn1.x509.X509Name.appendValue(java.lang.StringBuffer, java.util.Hashtable, com.android.org.bouncycastle.asn1.ASN1ObjectIdentifier, java.lang.String):void");
    }
