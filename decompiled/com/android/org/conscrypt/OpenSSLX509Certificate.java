...
public class OpenSSLX509Certificate extends X509Certificate {
    ...
    public boolean hasUnsupportedCriticalExtension() {
        return (NativeCrypto.get_X509_ex_flags(this.mContext) & NativeCrypto.SSL_kGOST) != 0;
    }
    ...
    public boolean equals(Object other) {
        ...
        return NativeCrypto.X509_cmp(this.mContext, ((OpenSSLX509Certificate) other).mContext) == 0;
    }
