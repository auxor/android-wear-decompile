...
public final class Leb128 {
    ...
    public static int readSignedLeb128(ByteInput in) {
        ...
        do {
            ...
            result |= (cur & Float.MAX_EXPONENT) << (count * 7);
            signBits <<= 7;
            count++;
    ...
    public static void writeUnsignedLeb128(ByteOutput out, int value) {
        for (int remaining = value >>> 7; remaining != 0; remaining >>>= 7) {
            out.writeByte((byte) ((value & Float.MAX_EXPONENT) | NodeFilter.SHOW_COMMENT));
            value = remaining;
        }
        out.writeByte((byte) (value & Float.MAX_EXPONENT));
    }
    ...
    public static void writeSignedLeb128(ByteOutput out, int value) {
        ...
        while (hasMore) {
            ...
            int i2 = value & Float.MAX_EXPONENT;
            if (hasMore) {
