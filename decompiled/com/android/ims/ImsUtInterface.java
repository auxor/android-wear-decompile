...
public interface ImsUtInterface {
    ...
    void updateCallBarring(int i, boolean z, Message message, String[] strArr);

    void updateCallForward(int i, int i2, String str, int i3, Message message);

    void updateCallWaiting(boolean z, Message message);
}
