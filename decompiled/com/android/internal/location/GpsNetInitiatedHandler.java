...
public class GpsNetInitiatedHandler {
    ...
    public GpsNetInitiatedHandler(Context context, INetInitiatedListener netInitiatedListener, boolean isSuplEsEnabled) {
        ...
        this.mLocationManager = (LocationManager) context.getSystemService(LocationManager.KEY_LOCATION_CHANGED);
        updateLocationMode();
    ...
    public boolean getInEmergency() {
        return (this.mIsInEmergency || Boolean.parseBoolean(SystemProperties.get(TelephonyProperties.PROPERTY_INECM_MODE))) ? DEBUG : false;
    }
    ...
    private synchronized void setNiNotification(GpsNiNotification notif) {
        ...
        if (notificationManager != null) {
            ...
            if (this.mNiNotification == null) {
                ...
                this.mNiNotification.when = 0;
            }
            Notification notification;
            if (this.mPlaySounds) {
                notification = this.mNiNotification;
                notification.defaults |= GPS_NI_TYPE_VOICE;
            } else {
                notification = this.mNiNotification;
            ...
            PendingIntent pi = PendingIntent.getBroadcast(this.mContext, GPS_ENC_NONE, !this.mPopupImmediately ? getDlgIntent(notif) : new Intent(), GPS_ENC_NONE);
