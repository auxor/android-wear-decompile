...
public class HbpcdLookup {
    ...
    public static class ArbitraryMccSidMatch implements BaseColumns {
        ...
        static {
            CONTENT_URI = Uri.parse("content://hbpcd_lookup/arbitrary");
        }
    }
    ...
    public static class MccIdd implements BaseColumns {
        ...
        static {
            CONTENT_URI = Uri.parse("content://hbpcd_lookup/idd");
        }
    }
    ...
    public static class MccLookup implements BaseColumns {
        ...
        static {
            CONTENT_URI = Uri.parse("content://hbpcd_lookup/lookup");
        }
    }
    ...
    public static class MccSidConflicts implements BaseColumns {
        ...
        static {
            CONTENT_URI = Uri.parse("content://hbpcd_lookup/conflict");
        }
    }
    ...
    public static class MccSidRange implements BaseColumns {
        ...
        static {
            CONTENT_URI = Uri.parse("content://hbpcd_lookup/range");
        }
    }
    ...
    public static class NanpAreaCode implements BaseColumns {
        ...
        static {
            CONTENT_URI = Uri.parse("content://hbpcd_lookup/nanp");
        }
    }

    static {
        CONTENT_URI = Uri.parse("content://hbpcd_lookup");
    }
}
