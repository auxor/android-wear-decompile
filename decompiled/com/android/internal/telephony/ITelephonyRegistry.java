        ...
        private static class Proxy implements ITelephonyRegistry {
            ...
            public void notifyCallStateForSubscriber(int subId, int state, String incomingNumber) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(state);
                    _data.writeString(incomingNumber);
                    this.mRemote.transact(Stub.TRANSACTION_notifyCallStateForSubscriber, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void notifySignalStrength(SignalStrength signalStrength) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_notifySignalStrength, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void notifySignalStrengthForSubscriber(int subId, SignalStrength signalStrength) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_notifySignalStrengthForSubscriber, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void notifyDataConnection(int state, boolean isDataConnectivityPossible, String reason, String apn, String apnType, LinkProperties linkProperties, NetworkCapabilities networkCapabilities, int networkType, boolean roaming) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(state);
                    _data.writeInt(isDataConnectivityPossible ? Stub.TRANSACTION_addOnSubscriptionsChangedListener : 0);
            ...
            public void notifyDataConnectionRealTimeInfo(DataConnectionRealTimeInfo dcRtInfo) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_notifyDataConnectionRealTimeInfo, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_notifyCallState /*5*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyCallStateForSubscriber /*6*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_notifyServiceStateForPhoneId /*7*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifySignalStrength /*8*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifySignalStrengthForSubscriber /*9*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyMessageWaitingChangedForPhoneId /*10*/:
                    data.enforceInterface(DESCRIPTOR);
                    notifyMessageWaitingChangedForPhoneId(data.readInt(), data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyCallForwardingChanged /*11*/:
                    data.enforceInterface(DESCRIPTOR);
                    notifyCallForwardingChanged(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyCallForwardingChangedForSubscriber /*12*/:
                    data.enforceInterface(DESCRIPTOR);
                    notifyCallForwardingChangedForSubscriber(data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyDataActivity /*13*/:
                    data.enforceInterface(DESCRIPTOR);
                    notifyDataActivity(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyDataActivityForSubscriber /*14*/:
                    data.enforceInterface(DESCRIPTOR);
                    notifyDataActivityForSubscriber(data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyDataConnection /*15*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyDataConnectionForSubscriber /*16*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyDataConnectionFailed /*17*/:
                    data.enforceInterface(DESCRIPTOR);
                    notifyDataConnectionFailed(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyDataConnectionFailedForSubscriber /*18*/:
                    data.enforceInterface(DESCRIPTOR);
                    notifyDataConnectionFailedForSubscriber(data.readInt(), data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyCellLocation /*19*/:
                    Bundle _arg03;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyCellLocationForSubscriber /*20*/:
                    Bundle _arg14;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                ...
                case TRANSACTION_notifyDataConnectionRealTimeInfo /*27*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyVoLteServiceStateChanged /*28*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifyOemHookRawEventForSubscriber /*29*/:
                    data.enforceInterface(DESCRIPTOR);
                    notifyOemHookRawEventForSubscriber(data.readInt(), data.createByteArray());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_notifySubscriptionInfoChanged /*30*/:
                    data.enforceInterface(DESCRIPTOR);
