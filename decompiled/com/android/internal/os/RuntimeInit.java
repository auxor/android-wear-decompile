...
public class RuntimeInit {
    ...
    private static class UncaughtHandler implements UncaughtExceptionHandler {
        ...
        public void uncaughtException(java.lang.Thread r8, java.lang.Throwable r9) {
            ...
            r7 = this;
            r6 = 10;
            r3 = com.android.internal.os.RuntimeInit.mCrashing;	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
        ...
        L_0x0013:
            r3 = 1;
            com.android.internal.os.RuntimeInit.mCrashing = r3;	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r3 = com.android.internal.os.RuntimeInit.mApplicationObject;	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            if (r3 != 0) goto L_0x0054;
        L_0x001d:
            r3 = "AndroidRuntime";
            r4 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r4.<init>();	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r5 = "*** FATAL EXCEPTION IN SYSTEM PROCESS: ";
            r4 = r4.append(r5);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r5 = r8.getName();	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r4 = r4.append(r5);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r4 = r4.toString();	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            com.android.internal.os.RuntimeInit.Clog_e(r3, r4, r9);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
        L_0x0039:
            r3 = android.app.ActivityManagerNative.getDefault();	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r4 = com.android.internal.os.RuntimeInit.mApplicationObject;	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r5 = new android.app.ApplicationErrorReport$CrashInfo;	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r5.<init>(r9);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r3.handleApplicationCrash(r4, r5);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r3 = android.os.Process.myPid();
            android.os.Process.killProcess(r3);
            java.lang.System.exit(r6);
            goto L_0x0012;
        L_0x0054:
            r0 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r0.<init>();	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r3 = "FATAL EXCEPTION: ";
            r3 = r0.append(r3);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r4 = r8.getName();	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r3 = r3.append(r4);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r4 = "\n";
            r3.append(r4);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r1 = android.app.ActivityThread.currentProcessName();	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            if (r1 == 0) goto L_0x0081;
        L_0x0072:
            r3 = "Process: ";
            r3 = r0.append(r3);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r3 = r3.append(r1);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r4 = ", ";
            r3.append(r4);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
        L_0x0081:
            r3 = "PID: ";
            r3 = r0.append(r3);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r4 = android.os.Process.myPid();	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r3.append(r4);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            r3 = "AndroidRuntime";
            r4 = r0.toString();	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            com.android.internal.os.RuntimeInit.Clog_e(r3, r4, r9);	 Catch:{ Throwable -> 0x0098, all -> 0x00ac }
            goto L_0x0039;
        L_0x0098:
            r2 = move-exception;
            ...
            com.android.internal.os.RuntimeInit.Clog_e(r3, r4, r2);	 Catch:{ Throwable -> 0x00b8, all -> 0x00ac }
        L_0x00a0:
            r3 = android.os.Process.myPid();
            android.os.Process.killProcess(r3);
            java.lang.System.exit(r6);
