        ...
        private static class Proxy implements IDropBoxManagerService {
            ...
            public boolean isTagEnabled(String tag) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_isTagEnabled, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = true;
                    }
            ...
            public Entry getNextEntry(String tag, long millis) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getNextEntry, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case TRANSACTION_add /*1*/:
                    ...
                    return true;
                case TRANSACTION_isTagEnabled /*2*/:
                    data.enforceInterface(DESCRIPTOR);
