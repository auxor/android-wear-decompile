...
public class BigInteger extends Number implements Comparable<BigInteger>, Serializable {
    ...
    static {
        ...
        SMALL_VALUES = new BigInteger[]{ZERO, ONE, new BigInteger(1, 2), new BigInteger(1, 3), new BigInteger(1, 4), new BigInteger(1, 5), new BigInteger(1, 6), new BigInteger(1, 7), new BigInteger(1, 8), new BigInteger(1, 9), TEN};
    }
    ...
    public BigInteger subtract(BigInteger value) {
        ...
        this(BigInt.subtraction(lhs, rhs));
        return this;
    }
    ...
    public long longValue() {
        ...
        prepareJavaRepresentation();
        return ((long) this.sign) * (this.numberLength > 1 ? (((long) this.digits[1]) << 32) | (((long) this.digits[0]) & 4294967295L) : ((long) this.digits[0]) & 4294967295L);
    }
    ...
    private byte[] twosComplement() {
        ...
        if (this.sign < 0) {
            ...
            while (bytesLen > firstByteNumber) {
                digit = temp.digits[digitIndex] ^ -1;
                digitIndex++;
                if (digitIndex == this.numberLength) {
                    bytesInInteger = highBytes;
                }
