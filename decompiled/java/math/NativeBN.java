...
final class NativeBN {
    ...
    public static native void BN_generate_prime_ex(long j, int i, boolean z, long j2, long j3, long j4);

    public static native int BN_hex2bn(long j, String str);

    public static native boolean BN_is_bit_set(long j, int i);

    public static native boolean BN_is_prime_ex(long j, int i, long j2);
