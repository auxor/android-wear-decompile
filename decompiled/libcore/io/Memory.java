...
public final class Memory {
    ...
    public static int peekInt(byte[] src, int offset, ByteOrder order) {
        ...
        offset = offset2 + 1;
        offset2 = offset + 1;
        i = ((((src[offset] & Opcodes.OP_CONST_CLASS_JUMBO) << 0) | ((src[offset2] & Opcodes.OP_CONST_CLASS_JUMBO) << 8)) | ((src[offset] & Opcodes.OP_CONST_CLASS_JUMBO) << 16)) | ((src[offset2] & Opcodes.OP_CONST_CLASS_JUMBO) << 24);
        offset = offset2;
        return i;
    }
    ...
    public static long peekLong(byte[] src, int offset, ByteOrder order) {
        ...
        offset2 = offset + 1;
        offset = offset2 + 1;
        l = ((((src[offset] & Opcodes.OP_CONST_CLASS_JUMBO) << 0) | ((src[offset2] & Opcodes.OP_CONST_CLASS_JUMBO) << 8)) | ((src[offset] & Opcodes.OP_CONST_CLASS_JUMBO) << 16)) | ((src[offset2] & Opcodes.OP_CONST_CLASS_JUMBO) << 24);
        offset2 = offset + 1;
        offset = offset2 + 1;
        offset2 = offset + 1;
