...
public final class GeofenceHardwareRequestParcelable implements Parcelable {
    ...
    static {
        CREATOR = new Creator<GeofenceHardwareRequestParcelable>() {
            public android.hardware.location.GeofenceHardwareRequestParcelable createFromParcel(android.os.Parcel r1) {
                /* JADX: method processing error */
/*
                Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.hardware.location.GeofenceHardwareRequestParcelable.1.createFromParcel(android.os.Parcel):android.hardware.location.GeofenceHardwareRequestParcelable
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.hardware.location.GeofenceHardwareRequestParcelable.1.createFromParcel(android.os.Parcel):android.hardware.location.GeofenceHardwareRequestParcelable
...
*/
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: android.hardware.location.GeofenceHardwareRequestParcelable.1.createFromParcel(android.os.Parcel):android.hardware.location.GeofenceHardwareRequestParcelable");
            }
