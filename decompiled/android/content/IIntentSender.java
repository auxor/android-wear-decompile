        ...
        private static class Proxy implements IIntentSender {
            ...
            public int send(int code, Intent intent, String resolvedType, IIntentReceiver finishedReceiver, String requiredPermission) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_send, _data, _reply, 0);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_send /*1*/:
                    ...
                    int _result = send(_arg0, _arg1, data.readString(), android.content.IIntentReceiver.Stub.asInterface(data.readStrongBinder()), data.readString());
