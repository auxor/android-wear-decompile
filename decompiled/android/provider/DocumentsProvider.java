...
public abstract class DocumentsProvider extends ContentProvider {
    ...
    public void attachInfo(Context context, ProviderInfo info) {
        ...
        this.mMatcher.addURI(this.mAuthority, "root", MATCH_ROOTS);
    ...
    public String getDocumentType(String documentId) throws FileNotFoundException {
        ...
        try {
            if (cursor.moveToFirst()) {
                str = cursor.getString(cursor.getColumnIndexOrThrow(Voicemails.MIME_TYPE));
            } else {
    ...
    public Bundle call(String method, String arg, Bundle extras) {
        ...
        Context context = getContext();
        Uri documentUri = (Uri) extras.getParcelable(Impl.COLUMN_URI);
        ...
        if (this.mAuthority.equals(authority)) {
            ...
            try {
                if (DocumentsContract.METHOD_CREATE_DOCUMENT.equals(method)) {
                    ...
                    out.putParcelable(Impl.COLUMN_URI, DocumentsContract.buildDocumentUriMaybeUsingTree(documentUri, createDocument(documentId, extras.getString(Voicemails.MIME_TYPE), extras.getString(OpenableColumns.DISPLAY_NAME))));
                    return out;
                } else if (DocumentsContract.METHOD_RENAME_DOCUMENT.equals(method)) {
                    enforceWritePermissionInner(documentUri, null);
                    String newDocumentId = renameDocument(documentId, extras.getString(OpenableColumns.DISPLAY_NAME));
                    ...
                    out.putParcelable(Impl.COLUMN_URI, newDocumentUri);
