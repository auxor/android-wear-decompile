...
public class SQLiteCursor extends AbstractWindowedCursor {
    ...
    public int getColumnIndex(String columnName) {
        if (this.mColumnNameMap == null) {
            ...
            HashMap<String, Integer> map = new HashMap(columnCount, LayoutParams.BRIGHTNESS_OVERRIDE_FULL);
        ...
        try {
            if (this.mWindow != null) {
                if (this.mStackTrace != null) {
                    ...
                    if (len > LayoutParams.TYPE_APPLICATION_PANEL) {
                        len = LayoutParams.TYPE_APPLICATION_PANEL;
                    }
