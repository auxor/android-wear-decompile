...
public class ErrorCodes {
    ...
    public static String asString(int code) {
        switch (code) {
            case ERROR_NOT_SUPPORTED /*-21*/:
                return "NOT_SUPPORTED";
            case ERROR_NO_SE_CONNECTED /*-20*/:
                return "NO_SE_CONNECTED";
            case ERROR_SE_CONNECTED /*-19*/:
                return "SE_CONNECTED";
            case ERROR_SE_ALREADY_SELECTED /*-18*/:
                return "SE_ALREADY_SELECTED";
            case ERROR_NOT_INITIALIZED /*-17*/:
                return "NOT_INITIALIZED";
            case ERROR_NFC_ON /*-16*/:
                return "NFC_ON";
            case ERROR_SOCKET_OPTIONS /*-15*/:
                return "SOCKET_OPTIONS";
            case ERROR_SERVICE_NAME_USED /*-14*/:
                return "SERVICE_NAME_USED";
            case ERROR_SAP_USED /*-13*/:
                return "SAP_USED";
            case ERROR_BUFFER_TO_SMALL /*-12*/:
                return "BUFFER_TO_SMALL";
            case ERROR_SOCKET_NOT_CONNECTED /*-11*/:
                return "SOCKET_NOT_CONNECTED";
            case ERROR_SOCKET_CREATION /*-10*/:
                return "SOCKET_CREATION";
            case ERROR_INSUFFICIENT_RESOURCES /*-9*/:
                return "INSUFFICIENT_RESOURCES";
            case ERROR_INVALID_PARAM /*-8*/:
                return "INVALID_PARAM";
            case ERROR_WRITE /*-7*/:
                return "WRITE";
            case ERROR_READ /*-6*/:
                return "READ";
            case ERROR_DISCONNECT /*-5*/:
                return "CONNECT/DISCONNECT";
            case ERROR_BUSY /*-4*/:
                return "BUSY";
            case ERROR_TIMEOUT /*-3*/:
                return "TIMEOUT";
            case ERROR_CANCELLED /*-2*/:
                return "CANCELLED";
            case ERROR_IO /*-1*/:
                return "IO";
