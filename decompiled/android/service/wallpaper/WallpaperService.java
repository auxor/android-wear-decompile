            ...
            if (forceRelayout || creating || surfaceCreating || formatChanged || z || typeChanged || flagsChanged || redrawNeeded || !this.mIWallpaperEngine.mShownReported) {
                try {
                    ...
                    if (!this.mCreated) {
                        ...
                        this.mWindowIsRound = ScreenShapeHelper.getWindowIsRound(WallpaperService.this.getResources());
                        windowStyle.recycle();
                    ...
                    if (this.mSurfaceHolder.mSurface.isValid()) {
                        ...
                        if (insetsChanged) {
                            ...
                            this.mFinalSystemInsets.bottom = this.mIWallpaperEngine.mDisplayPadding.bottom;
                            onApplyWindowInsets(new WindowInsets(this.mFinalSystemInsets, null, this.mFinalStableInsets, this.mWindowIsRound));
                        }
                        if (redrawNeeded) {
