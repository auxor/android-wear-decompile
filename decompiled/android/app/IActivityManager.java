...
public interface IActivityManager extends IInterface {
    ...
    public static final int CREATE_ACTIVITY_CONTAINER_TRANSACTION = 168;
    ...
    public static final int GET_HOME_ACTIVITY_TOKEN_TRANSACTION = 184;
    ...
    public static final int SYSTEM_BACKUP_RESTORED = 244;
    ...
    public static class ContentProviderHolder implements Parcelable {
        ...
        static {
            CREATOR = new Creator<ContentProviderHolder>() {
                public ContentProviderHolder createFromParcel(Parcel source) {
                    return new ContentProviderHolder(null);
                }
    ...
    public static class WaitResult implements Parcelable {
        ...
        static {
            CREATOR = new Creator<WaitResult>() {
                public WaitResult createFromParcel(Parcel source) {
                    return new WaitResult(null);
                }
    ...
    IActivityContainer createActivityContainer(IBinder iBinder, IActivityContainerCallback iActivityContainerCallback) throws RemoteException;
    ...
    IBinder getHomeActivityToken() throws RemoteException;
    ...
    boolean launchAssistIntent(Intent intent, int i, String str, int i2) throws RemoteException;
    ...
    void noteWakeupAlarm(IIntentSender iIntentSender, int i, String str) throws RemoteException;
    ...
    int startActivityAsCaller(IApplicationThread iApplicationThread, String str, Intent intent, String str2, IBinder iBinder, String str3, int i, int i2, ProfilerInfo profilerInfo, Bundle bundle, int i3) throws RemoteException;
    ...
    void systemBackupRestored() throws RemoteException;
