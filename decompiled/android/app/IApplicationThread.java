...
public interface IApplicationThread extends IInterface {
    ...
    void dumpMemInfo(FileDescriptor fileDescriptor, MemoryInfo memoryInfo, boolean z, boolean z2, boolean z3, String[] strArr) throws RemoteException;
    ...
    void scheduleRelaunchActivity(IBinder iBinder, List<ResultInfo> list, List<ReferrerIntent> list2, int i, boolean z, Configuration configuration) throws RemoteException;
