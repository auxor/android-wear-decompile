        ...
        private static class Proxy implements IServiceConnection {
            ...
            public void connected(ComponentName name, IBinder service) throws RemoteException {
                ...
                try {
                    ...
                    if (name != null) {
                        _data.writeInt(Stub.TRANSACTION_connected);
                        name.writeToParcel(_data, 0);
                    } else {
                        _data.writeInt(0);
                    }
                    _data.writeStrongBinder(service);
                    this.mRemote.transact(Stub.TRANSACTION_connected, _data, null, Stub.TRANSACTION_connected);
                } finally {
                    _data.recycle();
                }
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case TRANSACTION_connected /*1*/:
                    ...
                    connected(_arg0, data.readStrongBinder());
                    return true;
