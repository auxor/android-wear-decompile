...
class KeyframeSet implements Keyframes {
    ...
    public static KeyframeSet ofInt(int... values) {
        ...
        if (numKeyframes == 1) {
            ...
            keyframes[1] = (IntKeyframe) Keyframe.ofInt(LayoutParams.BRIGHTNESS_OVERRIDE_FULL, values[0]);
        } else {
    ...
    public static KeyframeSet ofFloat(float... values) {
        ...
        if (numKeyframes == 1) {
            ...
            keyframes[1] = (FloatKeyframe) Keyframe.ofFloat(LayoutParams.BRIGHTNESS_OVERRIDE_FULL, values[0]);
    ...
    public static KeyframeSet ofObject(Object... values) {
        ...
        if (numKeyframes == 1) {
            ...
            keyframes[1] = (ObjectKeyframe) Keyframe.ofObject(LayoutParams.BRIGHTNESS_OVERRIDE_FULL, values[0]);
        } else {
