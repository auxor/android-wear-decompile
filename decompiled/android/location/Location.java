...
public class Location implements Parcelable {
    ...
    public static double convert(String coordinate) {
        ...
        try {
            ...
            boolean isNegative180 = negative && deg == R.styleable.Theme_alertDialogIcon && min == 0.0d && sec == 0.0d;
            if (((double) deg) < 0.0d || (deg > R.styleable.Theme_horizontalScrollViewStyle && !isNegative180)) {
                throw new IllegalArgumentException("coordinate=" + coordinate);
