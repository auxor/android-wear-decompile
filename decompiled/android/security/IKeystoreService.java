        ...
        private static class Proxy implements IKeystoreService {
            ...
            public int test() throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_test, _data, _reply, 0);
            ...
            public String[] saw(String name, int uid) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(name);
                    _data.writeInt(uid);
                    this.mRemote.transact(Stub.TRANSACTION_saw, _data, _reply, 0);
                    _reply.readException();
                    int size = _reply.readInt();
                    String[] strArr = new String[size];
                    for (int i = 0; i < size; i += Stub.TRANSACTION_test) {
                        strArr[i] = _reply.readString();
                    }
                    if (_reply.readInt() != Stub.TRANSACTION_test) {
                        return null;
                    }
                    _reply.recycle();
                    _data.recycle();
            ...
            public int password(String password) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_password, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int zero() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_zero, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int generate(String name, int uid, int keyType, int keySize, int flags, byte[][] args) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    if (args == null) {
                        ...
                        for (int i = 0; i < args.length; i += Stub.TRANSACTION_test) {
            ...
            public int import_key(String name, byte[] data, int uid, int flags) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(uid);
                    _data.writeInt(flags);
                    this.mRemote.transact(Stub.TRANSACTION_import, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int del_key(String name, int uid) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(name);
                    _data.writeInt(uid);
                    this.mRemote.transact(Stub.TRANSACTION_del_key, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int reset_uid(int uid) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(uid);
                    this.mRemote.transact(Stub.TRANSACTION_reset_uid, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int sync_uid(int srcUid, int dstUid) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_sync_uid, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int password_uid(String password, int uid) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(password);
                    _data.writeInt(uid);
                    this.mRemote.transact(Stub.TRANSACTION_password_uid, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
