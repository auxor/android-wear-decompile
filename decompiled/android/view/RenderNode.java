...
public class RenderNode {
    ...
    public void end(HardwareCanvas endCanvas) {
        if (endCanvas instanceof GLES20RecordingCanvas) {
            ...
            canvas.onPostDraw();
            nSetDisplayListData(this.mNativeRenderNode, canvas.finishRecording());
            canvas.recycle();
            this.mValid = true;
            return;
        }
    ...
    public void destroyDisplayListData() {
        if (this.mValid) {
            nSetDisplayListData(this.mNativeRenderNode, 0);
            this.mValid = false;
        }
    }
    ...
    public boolean setLayerPaint(Paint paint) {
        return nSetLayerPaint(this.mNativeRenderNode, paint != null ? paint.mNativePaint : 0);
    }
