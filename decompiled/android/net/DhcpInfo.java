...
public class DhcpInfo implements Parcelable {
    ...
    static {
        CREATOR = new Creator<DhcpInfo>() {
            public android.net.DhcpInfo createFromParcel(android.os.Parcel r1) {
                /* JADX: method processing error */
/*
                Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.DhcpInfo.1.createFromParcel(android.os.Parcel):android.net.DhcpInfo
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.DhcpInfo.1.createFromParcel(android.os.Parcel):android.net.DhcpInfo
...
*/
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: android.net.DhcpInfo.1.createFromParcel(android.os.Parcel):android.net.DhcpInfo");
            }
