...
public final class WifiActivityEnergyInfo implements Parcelable {
    ...
    static {
        CREATOR = new Creator<WifiActivityEnergyInfo>() {
            public android.net.wifi.WifiActivityEnergyInfo createFromParcel(android.os.Parcel r1) {
                /* JADX: method processing error */
/*
                Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.wifi.WifiActivityEnergyInfo.1.createFromParcel(android.os.Parcel):android.net.wifi.WifiActivityEnergyInfo
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.wifi.WifiActivityEnergyInfo.1.createFromParcel(android.os.Parcel):android.net.wifi.WifiActivityEnergyInfo
...
*/
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: android.net.wifi.WifiActivityEnergyInfo.1.createFromParcel(android.os.Parcel):android.net.wifi.WifiActivityEnergyInfo");
            }
