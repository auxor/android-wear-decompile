...
public class WifiLinkLayerStats implements Parcelable {
    ...
    static {
        CREATOR = new Creator<WifiLinkLayerStats>() {
            public android.net.wifi.WifiLinkLayerStats createFromParcel(android.os.Parcel r1) {
                /* JADX: method processing error */
/*
                Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.wifi.WifiLinkLayerStats.1.createFromParcel(android.os.Parcel):android.net.wifi.WifiLinkLayerStats
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.wifi.WifiLinkLayerStats.1.createFromParcel(android.os.Parcel):android.net.wifi.WifiLinkLayerStats
...
*/
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: android.net.wifi.WifiLinkLayerStats.1.createFromParcel(android.os.Parcel):android.net.wifi.WifiLinkLayerStats");
            }
