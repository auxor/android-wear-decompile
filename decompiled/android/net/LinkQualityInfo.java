...
public class LinkQualityInfo implements Parcelable {
    ...
    static {
        CREATOR = new Creator<LinkQualityInfo>() {
            public android.net.LinkQualityInfo createFromParcel(android.os.Parcel r1) {
                /* JADX: method processing error */
/*
                Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.net.LinkQualityInfo.1.createFromParcel(android.os.Parcel):android.net.LinkQualityInfo
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.net.LinkQualityInfo.1.createFromParcel(android.os.Parcel):android.net.LinkQualityInfo
...
*/
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: android.net.LinkQualityInfo.1.createFromParcel(android.os.Parcel):android.net.LinkQualityInfo");
            }
