        ...
        while (i < end) {
            ...
            while (j < style.length) {
                ...
                if (style[j] instanceof ForegroundColorSpan) {
                    ...
                    String color = Integer.toHexString(((ForegroundColorSpan) style[j]).getForegroundColor() + AsyncService.CMD_ASYNC_SERVICE_DESTROY);
    ...
    private static void withinStyle(StringBuilder out, CharSequence text, int start, int end) {
        ...
        while (i < end) {
            ...
            if (c == '<') {
                ...
                if (d >= '\udc00' && d <= '\udfff') {
                    i++;
                    out.append("&#").append((Protocol.BASE_SYSTEM_RESERVED | ((c - 55296) << 10)) | (d - 56320)).append(";");
                }
            }
            i++;
        }
