...
class HtmlToSpannedConverter implements ContentHandler {
    ...
    private static class Header {
        ...
        public Header(int r1) {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.text.HtmlToSpannedConverter.Header.<init>(int):void
...
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.text.HtmlToSpannedConverter.Header.<init>(int):void
...
*/
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: android.text.HtmlToSpannedConverter.Header.<init>(int):void");
        }

        static /* synthetic */ int access$900(android.text.HtmlToSpannedConverter.Header r1) {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.text.HtmlToSpannedConverter.Header.access$900(android.text.HtmlToSpannedConverter$Header):int
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.text.HtmlToSpannedConverter.Header.access$900(android.text.HtmlToSpannedConverter$Header):int
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
...
*/
            ...
            // Can't load method instructions.
            */
            throw new UnsupportedOperationException("Method not decompiled: android.text.HtmlToSpannedConverter.Header.access$900(android.text.HtmlToSpannedConverter$Header):int");
        }
    }
    ...
    private static class Href {
        ...
        public Href(java.lang.String r1) {
            /* JADX: method processing error */
/*
            Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.text.HtmlToSpannedConverter.Href.<init>(java.lang.String):void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:113)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:263)
	at jadx.core.ProcessClass.process(ProcessClass.java:34)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.DecodeException:  in method: android.text.HtmlToSpannedConverter.Href.<init>(java.lang.String):void
	at jadx.core.dex.instructions.InsnDecoder.decodeInsns(InsnDecoder.java:46)
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:98)
	... 8 more
...
*/
            ...
            // Can't load method instructions.
            */
            throw new UnsupportedOperationException("Method not decompiled: android.text.HtmlToSpannedConverter.Href.<init>(java.lang.String):void");
        }
    }
    ...
    static {
        HEADER_SIZES = new float[]{1.5f, 1.4f, 1.3f, 1.2f, 1.1f, RemoteControlClient.PLAYBACK_SPEED_1X};
    }
    ...
    private static void endHeader(SpannableStringBuilder text) {
        ...
        if (where != len) {
            text.setSpan(new RelativeSizeSpan(HEADER_SIZES[Header.access$900(obj)]), where, len, 33);
