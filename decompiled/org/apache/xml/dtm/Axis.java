...
public final class Axis {
    ...
    static {
        ...
        names = new String[]{Constants.ATTRVAL_ANCESTOR, "ancestor-or-self", Constants.ELEMNAME_ATTRIBUTE_STRING, "child", "descendant", "descendant-or-self", "following", "following-sibling", "namespace-decls", Constants.ATTRNAME_NAMESPACE, "parent", "preceding", "preceding-sibling", "self", "all-from-node", "preceding-and-ancestor", "all", "descendants-from-root", "descendants-or-self-from-root", Constants.ELEMNAME_ROOT_STRING, "filtered-list"};
    }
