...
public class XResources_cy extends XResourceBundle {
    public Object[][] getContents() {
        ...
        objArr2[0] = XResourceBundle.LANG_MULTIPLIER_CHAR;
        objArr2[1] = new CharArrayWrapper(new char[]{'\u03d9'});
        r0[10] = objArr2;
        ...
        objArr2[1] = new StringArrayWrapper(new String[]{"hundreds", "tens", "digits"});
        r0[15] = objArr2;
        return r0;
    }
}
